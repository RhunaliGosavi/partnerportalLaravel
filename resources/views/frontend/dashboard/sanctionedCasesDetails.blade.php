        ...
        success: function (response) {
            ...
            if(res.length>0){
                $.each(res, function(key, value) {
                        ...
                        html+='<tr><td>'+(key+1)+'</td><td>'+res[key]['application_number']+'</td><td>'+res[key]['customer_name']+'</td><td>'+res[key]['product_type']+'</td><td>'+res[key]['sanctioned_amount']+'</td><td>'+res[key]['sanctioned_date']+'</td><td>'+res[key]['application_status']+'</td></tr>';
