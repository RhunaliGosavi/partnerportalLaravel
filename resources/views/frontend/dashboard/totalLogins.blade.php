    ...
    <div class="login-search">
      <div class="page-heading">
          ...
          <nav aria-label="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="{{url('dashboard/totallogins')}}">Total Logins</a></li>
              </ol>
          </nav>
      </div>
      <form>
...
@section('content')
   ...
   function getSearchResult(){
    ...
    $.ajax({
        ...
        type: "post",
        data: {'start_date':start_date,'end_date':end_date,'to_month':to_month,'to_year':to_year,'search_val':searchval,'type':'login',_token: '{{csrf_token()}}'} ,
