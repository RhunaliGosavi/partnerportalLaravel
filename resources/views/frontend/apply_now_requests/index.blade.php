      ...
      <div class="page-heading">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{url('apply/now')}}">Apply now</a></li>
          </ol>
        </nav>
      </div>
    </section>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="00/00/0000 HH:MM" id="datetimepicker1" name="prefered_contact_time" id="preferTime" value="{{old('prefered_contact_time')}}">
