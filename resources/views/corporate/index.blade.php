				...
				<div class="m-portlet__head">
					<div class="m-portlet__head-caption">
						<div class="m-portlet__head-title">
							<h3 class="m-portlet__head-text">Corporate Presentations</h3>
						</div>
					</div>
					<div class="m-portlet__head-tools">
						<div class="row">
		                    <div class="col-xl-3 order-2 order-xl-1">
								<a href="{{url('/corporatePpt/create')}}" border='0'>
			...
			table = $('#corporatePpt').mDatatable( {
                data: {
                    ...
                    source: {
                        ...
                        // sample GET method
	                        method: 'get',
	                        url: base_url+'/fetchcorporatePptList',
	                        map: function(raw) {
	                            // sample data mapping
	                          	var dataSet = raw;
              	...
              	"columns": [
                    ...
                    { 
		                ...
		                template:function(row,a,i)  {
		                	html = '<a href="'+base_url+'/corporatePpt/edit/'+row.id+'" title="Edit DSA" class="dropdown-item"><i class="la la-edit"></i>Edit DSA</a><a href="'+base_url+'/corporatePpt/delete/'+row.id+'" title="Delete DSA" class="dropdown-item"><i class="la la-trash"></i>Delete DSA</a><a href="'+base_url+'/storage/corporate/'+row.file_path+'" title="Download DSA" class="dropdown-item"><i class="la la-download"></i>Download DSA</a>';
