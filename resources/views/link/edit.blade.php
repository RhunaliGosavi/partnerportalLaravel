				...
				<div class="m-portlet__head">
					<div class="m-portlet__head-caption">
						<div class="m-portlet__head-title">
							<h3 class="m-portlet__head-text"> Edit Link</h3>
						</div>
					</div>
				</div>
				<form class="m-form m-form--fit m-form--label-align-right" action="{{url('link/update').'/'.$link->id}}" method="POST">
					@csrf
					<div class="m-portlet__body">
						<div class="form-group m-form__group row {{ $errors->has('portal_name') ? 'has-danger' : ''}}">
							...
							<div class="col-md-4">
								<input type="text" name="portal_name" placeholder="Portal Name" value="{{$link->portal_name}}" class="form-control">
						...
						<div class="form-group m-form__group row {{ $errors->has('web_link') ? 'has-danger' : ''}}">
							...
							<div class="col-md-4">
								<input type="text" name="web_link" placeholder="Web Link" value="{{$link->web_link}}" class="form-control">
