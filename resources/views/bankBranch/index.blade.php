				...
				<div class="m-portlet__head">
					<div class="m-portlet__head-caption">
						<div class="m-portlet__head-title">
							<h3 class="m-portlet__head-text"> Bank Branch List</h3>
						</div>
					</div>
					<div class="m-portlet__head-tools">
						<div class="row">
							<div class="col-xl-3 order-2 order-xl-1">
								<form name="import_file" id="import_file" action="{{url('banks/import')}}" method="post" enctype="multipart/form-data">
		                            {{ csrf_field() }}
              	...
              	"columns": [
                    ...
                    { 
		                ...
		                template:function(row,a,i)  {
		                	var html = '<a href="'+base_url+'/banks/delete/'+row.id+'" title="Delete Record" class="dropdown-item"><i class="la la-trash"></i>Delete Record</a></div>';
