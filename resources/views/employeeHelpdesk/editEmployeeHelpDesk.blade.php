							...
							<div class="form-group m-form__group row {{ $errors->has('download_flag') ? 'has-danger' : ''}}">
								...
								<div class="col-md-4 m-radio-inline">
									<label class="m-radio m-radio--solid">
										<input type="radio" name="download_flag" value="1" @if(old('download_flag',$data->download_flag)) checked="checked" @endif> Yes
										<span></span>
									</label>
									<label class="m-radio m-radio--solid">
										<input type="radio" name="download_flag" value="0" @if(!old('download_flag',$data->download_flag)) checked="checked" @endif> No
										<span></span>
									</label>
