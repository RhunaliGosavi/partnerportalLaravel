...
@section('content')
				...
				<div class="m-portlet__head">
					<div class="m-portlet__head-caption">
						<div class="m-portlet__head-title">
							<h3 class="m-portlet__head-text"> Sales Contest</h3>
						</div>
					</div>
					<div class="m-portlet__head-tools">
						<div class="row">
                            <div class="col-xl-3 order-2 order-xl-1">
								<a href="{{url('/salesContest/create')}}" border='0'>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			table = $('#salesContestData').mDatatable( {
                data: {
                    type: 'remote',
                    source: {
                      	read: {
              	...
              	"columns": [
                    ...
                    { 
                        ...
                        template: function(row, index, datatable) {	
                            return '<a href="'+base_url+'/storage/sales/kit/marketinginformation/salescontest/'+row.file_path+'">'+row.file_path+'</a>'; 
                        }
                    },
