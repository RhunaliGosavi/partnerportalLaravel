...
@section('content')
				...
				<div class="m-portlet__head">
					<div class="m-portlet__head-caption">
						<div class="m-portlet__head-title">
							<h3 class="m-portlet__head-text"> Marketing Visuals</h3>
						</div>
					</div>
					<div class="m-portlet__head-tools">
						<div class="row">
                            <div class="col-xl-3 order-2 order-xl-1">
								<a href="{{url('/marketingVisuals/create')}}" border='0'>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			table = $('#marketingVisualsData').mDatatable( {
                data: {
                    type: 'remote',
                    source: {
                      	read: {
                        // sample GET method
	                        method: 'get',
	                        url: base_url+'/marketingVisuals/all',
	                        map: function(raw) {
	                            // sample data mapping
	                          	var dataSet = raw;
              	...
              	"columns": [
                    ...
                    { 
		                ...
		                template:function(row,a,i)  {
		                	var html = '<a href="'+base_url+'/marketingVisuals/delete/'+row.id+'" title="Delete Record" class="dropdown-item"><i class="la la-trash"></i>Delete Record</a><a href="'+base_url+'/marketingVisuals/edit/'+row.id+'" title="Delete Record" class="dropdown-item"><i class="la la-trash"></i>Edit Record</a></div>';
