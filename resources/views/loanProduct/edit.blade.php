    ...
    <div class="row">
		<div class="col-md-12">
			<div class="m-portlet">
                ...
                <form class="m-form m-form--fit m-form--label-align-right" action="{{url('loanProduct/update/'.$lProduct->id)}}" method="POST" enctype="multipart/form-data">
					@csrf
					<div class="m-portlet__body">
                        ...
                        <div class="form-group m-form__group row {{ $errors->has('icon') ? 'has-danger' : ''}}">
                            ...
                            <div class="col-md-4">
                                <input type="file" name="icon"  id="icon" value="{{old('icon',$lProduct->icon)}}" class="form-control">
                                @if ($errors->has('icon'))
                                <div class="form-control-feedback">
                                    {{ $errors->first('icon') }}
                                </div>
