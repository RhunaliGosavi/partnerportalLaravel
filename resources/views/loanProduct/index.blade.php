              	...
              	"columns": [
                    ...
                    { 
		                ...
		                template:function(row,a,i)  {
		                	var html = '<a href="'+base_url+'/loanProduct/edit/'+row.id+'" title="Edit Record" class="dropdown-item"><i class="la la-pencil"></i>Edit Record</a><a href="'+base_url+'/loanProduct/delete/'+row.id+'" title="Delete Record" class="dropdown-item"><i class="la la-trash"></i>Delete Record</a></div>';
