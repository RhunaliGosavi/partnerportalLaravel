				...
				<div class="m-portlet__head">
					<div class="m-portlet__head-caption">
						<div class="m-portlet__head-title">
							<h3 class="m-portlet__head-text">Relationship With Customer</h3>
						</div>
					</div>
					<div class="m-portlet__head-tools">
						<div class="row">
						   <div class="col-xl-3 order-2 order-xl-1">
		                    ...
		                    <div class="col-xl-3 order-2 order-xl-1">
								<a href="{{url('/relationship_with_customer/create')}}" border='0'>
			...
			table = $('#employeeHelpDesk').mDatatable( {
                data: {
                    ...
                    source: {
                        ...
                        // sample GET method
	                        method: 'get',
	                        url: base_url+'/fetchRelationshipWithCustomer',
	                        map: function(raw) {
	                            // sample data mapping
	                          	var dataSet = raw;
              	...
              	"columns": [
...

				    {
		                ...
		                template:function(row,a,i)  {
		                	var html = '<a href="'+base_url+'/relationshipWithCustomer/delete/'+row.id+'" title="Delete " class="dropdown-item"><i class="la la-trash"></i>Delete </a><a href="'+base_url+'/relationshipwithCustomer/edit/'+row.id+'" title="Edit " class="dropdown-item"><i class="la la-trash"></i>Edit </a></div>';
